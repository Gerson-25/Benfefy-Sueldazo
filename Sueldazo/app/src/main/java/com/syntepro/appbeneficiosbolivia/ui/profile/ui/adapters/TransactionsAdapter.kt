package com.syntepro.appbeneficiosbolivia.ui.profile.ui.adapters
...
import com.syntepro.appbeneficiosbolivia.ui.profile.ui.TransactionDiff
...
//                    itemList
//                } else {
//                    val resultList = ArrayList<TransactionResponse>()
//                    for (row in itemList) {
//                        if (row.tipoTransaccion.toString() == charString) {
//                            resultList.add(row)
//                        }
//                    }
//                    resultList
...
//                filterListResult = filterResults!!.values as ArrayList<TransactionResponse>
//                notifyDataSetChanged()
//                if (filterListResult.isNullOrEmpty())
//                    (ctx as BaseActivity).showEmptyLayout(true)
//                else
//                    (ctx as BaseActivity).showEmptyLayout(false)
//            }
//
//        }
//    }
