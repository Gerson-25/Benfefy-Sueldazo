package com.syntepro.appbeneficiosbolivia.ui.benefy
...
import com.syntepro.appbeneficiosbolivia.entity.app.QRCode
...
import com.syntepro.appbeneficiosbolivia.ui.shop.ui.activities.CouponGiftDetailActivity
...
class BenefyDetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        giftDetail.setOnClickListener { presentDetail?.let { callIntent<CouponGiftDetailActivity> { this.putExtra("model", it) } }  }
