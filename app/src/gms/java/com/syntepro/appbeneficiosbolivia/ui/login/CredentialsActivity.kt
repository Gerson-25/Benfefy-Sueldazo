...
import com.syntepro.appbeneficiosbolivia.ui.login.model.ValidarClienteRequest
import com.syntepro.appbeneficiosbolivia.ui.login.model.ValidarClienteResponse
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        login.setOnClickListener {
            if (documentIsTyped() && termsAcepted()){
                ...
                showError(this@CredentialsActivity,  "Ingrese su número de cédula y acepte los términos y condiciones", "Formulario incompleto")
            }
        }
