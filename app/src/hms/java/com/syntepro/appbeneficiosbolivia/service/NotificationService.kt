...
import com.syntepro.appbeneficiosbolivia.ui.explore.CercaDeTiActivity
...
class NotificationService : Service() {
    ...
    private fun notificationCallO(titulo: String, mensaje: String) {
        ...
        val notification = NotificationCompat.Builder(this, "channel1")
                .setSmallIcon(R.drawable.ic_beneficios)
    ...
    private fun notificationCall(titulo: String, mensaje: String) {
        ...
        val builder = NotificationCompat.Builder(this)
                ...
                .setAutoCancel(true)
                .setContentIntent(pendingIntent)
                .setLargeIcon(BitmapFactory.decodeResource(resources, R.drawable.ic_beneficios))
                .setContentTitle(titulo)
                .setContentText(mensaje)
                .setStyle(
                        NotificationCompat.BigTextStyle()
    ...
    companion object {
        ...
        const val MIN_DISTANCE_NOTIFICATION_CHANCE: Long = 5 //5 Metros
    }
}