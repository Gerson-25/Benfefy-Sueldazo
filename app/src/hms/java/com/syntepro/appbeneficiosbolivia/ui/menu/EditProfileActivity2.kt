...
import kotlinx.android.synthetic.hms.activity_edit_profile2.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            when (provenance) {
                ...
                3 -> {
                    ...
                    giftMaterialCard.visibility = View.GONE
                    adapter.open()
                    val country = adapter.getCountryInfoAbr(Constants.userProfile?.actualCountry
                            ?: "BO")
        ...
        editDeliveryLocation.setOnClickListener {
            callIntent<MapDeliveryActivity> (922) {
                ...
                this.putParcelableArrayListExtra("dispatchPoints", ArrayList(dispatchPoints ?: arrayListOf()))
                this.putParcelableArrayListExtra("deliveryPrices", ArrayList(deliveryPrices ?: arrayListOf()))
            ...
            filePath.putFile(mImageUri!!).addOnSuccessListener {
                ...
                try {
                    ...
                    val thumbRef = mStorage!!.child(Constants.PROFILE_THUMBS_IMAGE_PATH)
                            .child(imageName)
                    thumbRef.putBytes(thumbByte).addOnCompleteListener { filePath.downloadUrl.addOnSuccessListener { uri -> thumbRef.downloadUrl.addOnSuccessListener { uri2 ->
            ...
            try {
                ...
                if (ret.isSuccessful) {
                    ...
                    if (response.isSuccess) {
                        ...
                        showError()
                        completion(false)
                        Toast.makeText(this@EditProfileActivity2, response.description
