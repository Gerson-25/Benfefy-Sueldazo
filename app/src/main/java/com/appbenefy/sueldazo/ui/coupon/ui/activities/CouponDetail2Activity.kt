...
//    }
    ...
    private fun shareContent(content: String, id: String?, country: String) {
        ...
        val bitmap = getBitmapFromView(itemId)
        try {
            ...
            val dynamicLink = FirebaseDynamicLinks.getInstance().createDynamicLink()
                    ...
                    .setDomainUriPrefix("https://sueldazoapp.page.link") // Open links with this app on Android
                    ...
                    .addOnCompleteListener(this) { task ->
                        if (task.isSuccessful) {
                            ...
                            val imageUri = FileProvider.getUriForFile(
                                    ...
                                    "com.appbenefy.sueldazo.provider",  //(use your app signature + ".provider" )
                                    file)
    ...
    */
    private fun createAppLinking(id: String?, category: String, country: String) {
        val builder = AppLinking.Builder()
                .setUriPrefix("https://sueldazoapp.page.link")
